<template>
  <q-page>
    ...
    <div class="q-pa-lg text-justify">
      <q-card class="q-pr-md q-pl-md" flat bordered>
        <q-card-section>
          <div class="text-h4 q-mb-lg q-mt-lg text-left">Terms and Conditions</div>
          <p>Welcome to Tresee!</p>
          <p>These terms and conditions outline the rules and regulations for the use of Tresee's Website, located at
            https://tresee.app.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Tresee if
        ...
        <q-card-section>
          ...
          <div class="text-h4 q-mb-lg text-left">Cookies</div>

          <p>We employ the use of cookies. By accessing Tresee, you agreed to use cookies in agreement with the Tresee's
            Privacy Policy.</p>
        ...
        <q-card-section>
          ...
          <div class="text-h4 q-mb-lg text-left">License</div>

          <p>Unless otherwise stated, Tresee and/or its licensors own the intellectual property rights for all material
            on Tresee. All intellectual property rights are reserved. You may access this from Tresee for your own
            personal use subjected to restrictions set in these terms and conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Tresee</li>
            <li>Sell, rent or sub-license material from Tresee</li>
            <li>Reproduce, duplicate or copy material from Tresee</li>
            <li>Redistribute content from Tresee</li>
          </ul>

          <p>This Agreement shall begin on the date hereof.</p>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. Tresee does not filter, edit, publish or review Comments prior to their
            presence on the website. Comments do not reflect the views and opinions of Tresee,its agents and/or
            affiliates. Comments reflect the views and opinions of the person who post their views and opinions.
            To the extent permitted by applicable laws, Tresee shall not be liable for the Comments or for any
          ...
          <p>Tresee reserves the right to monitor all Comments and to remove any Comments which can be considered
          ...
          <p>You hereby grant Tresee a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <q-card-section>
          ...
          <div class="text-h4 q-mb-lg text-left">Hyperlinking to our Content</div>
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            absence of Tresee; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to Tresee. Please include your name, your organization
          ...
          <p>No use of Tresee's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>

        </q-card-section>
        <q-card-section>

          <div class="text-h4 q-mb-lg text-left">iFrames</div>
        ...
        <q-card-section>
          ...
          <div class="text-h4 q-mb-lg text-left">Content Liability</div>
        ...
        <q-card-section>
          ...
          <div class="text-h4 q-mb-lg text-left">Reservation of Rights</div>
        ...
        <q-card-section>
          ...
          <div class="text-h4 q-mb-lg text-left">Removal of links from our website</div>
        ...
        <q-card-section>
          ...
          <div class="text-h4 q-mb-lg text-left">Disclaimer</div>
