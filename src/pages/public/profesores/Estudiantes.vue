            ...
            >
              ...
              <q-card-section>
                <q-btn
                  ...
                  :to="'/DEMO/profesor/estudiante/'+estudiante.idusuario"
                />
                <div :class="$q.screen.gt.sm?'text-h6':'text-body1 text-bold'">
                  {{estudiante.nombre}}
                </div>
    ...
    data() {
      return {
        ...
        listadoEstudiantes: [{
          ...
          genero: "HOMBRE",
          fotoPerfil: require("./assets/demo/perfil_fer.jpg"),
        ...
        },
          {
            ...
            genero: "MUJER",
            fotoPerfil: require("./assets/demo/perfil_mari.jpg"),
          ...
          },
          {
            ...
            genero: "HOMBRE",
            fotoPerfil: require("./assets/demo/perfil_paco.jpg"),
          ...
          },
          {
            ...
            genero: "HOMBRE",
            fotoPerfil: require("./assets/demo/perfil_richard.jpeg"),
          ...
          },
          {
            ...
            genero: "HOMBRE",
            fotoPerfil: require("./assets/demo/perfil_pacheco.jpg"),
            dataNacimiento: '',
            empresa: {
              idempresa: 5,
              nombre: 'telejrom',
          ...
          },
          {
            ...
            genero: "HOMBRE",
            fotoPerfil: require("./assets/demo/perfil_manolo.jpg"),
