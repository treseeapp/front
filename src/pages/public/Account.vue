        ...
        <q-card-section>
          ...
          <div class="row">
            <q-input input-class="text-grey-6" outlined v-model="usuario.email" type="email" label="Email" readonly
              ...
              <q-tooltip content-class="bg-red-9 content-center" content-style="font-size: 0.9em" class="justify-center"
                         :delay="500" :offset="[0, 5]">
...
<script>
  ...
  export default {
    ...
    async created() {
      ...
      this.parserDirection('Carrer Cabana, 31, 07141, Marratxi, España');
    ...
    data() {
      return {
        ...
        usuario: {
          nombre: 'Demo',
          email: 'demouser@tresee.app',
          apellidos: 'User',
          direccion: '',
          dataNacimiento: '1998/12/17',
          genero: 'HOMBRE',
          foto: "https://cdn.quasar.dev/img/boy-avatar.png", // foto placeholder por si el usuario no tiene foto
          modoInicioSesion: 'local',
    ...
    methods: {
      ...
      async fotoSubida() {
        this.mostrarNotificacion("Foto actualizada", "green");
      },
